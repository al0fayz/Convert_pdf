  ...
  <div class=" container-fluid   container-fixed-lg">
    <div class="card card-transparent">
      ...
      <div class=" container-fluid   container-fixed-lg">
        ...
        <div class="card card-transparent">
          <div class="card-header ">
            <div class="card-title bold"><b>DNS type</b>
            </div>
            ...
            <div class="col-lg-6 sm-no-padding">
              <div class="p-r-30">
                <table class="table-new">
                  <tbody>
                    <tr>
                      <td><span class="dot"></span>DNS TXT</td>
                      <td>(32,404)</td>
                      <td><b>51,6%</b></td>
                    </tr>
                    <tr>
                      <td><span class="dot1"></span>DNS MX</td>
                      <td>(27,333)</td>
                      <td><b>43,5%</b></td>
                    </tr>
                    <tr>
                      <td><span class="dot2"></span>DNS NS</td>
                      <td>(2,286)</td>
                      <td><b>3,6%</b></td>
                    </tr>
                    <tr>
                      <td><span class="dot3"></span>DNS SEC</td>
                      <td>(782)</td>
                      <td><b>1,2%</b></td>
                    </tr>
                  </tbody>
        ...
        <!-- <div class=" container-fluid   container-fixed-lg"> -->
          ...
          <div class="card card-transparent">
            <div class="card-header ">
              <div class="card-title bold"><b>DNS TXT</b>
              </div>
              <div class="card-controls">
                <ul>
                  <li><a href="#" class="card-collapse" data-toggle="collapse"><i
            ...
            <div class="card-body d-flex flex-wrap">
              ...
              <div class="col-lg-12 sm-no-padding">
                <div class="p-r-30">
                  ...
                  <tbody>
                    <tr>
                      <td><span class="dot"></span>SPF</td>
                      <td>(32,404)</td>
                      <td><b>0%</b></td>
                    </tr>
                    <tr>
                      <td><span class="dot1"></span>Verification</td>
                      <td>(27,333)</td>
                      <td><b>43,5%</b></td>
                    </tr>
                    <tr>
                      <td><span class="dot2"></span>DKIM</td>
                      <td>(2,286)</td>
                      <td><b>0%</b></td>
                    </tr>
                  </tbody>
      ...
      <script>
        ...
        var myCanvas = document.getElementById("myChart01");
        myCanvas.width = 1030;
        myCanvas.height = 30;
        var myData = {
          "SPF" : 0,
        ...
        myBarchart.draw();
          ...
          canvas1 = function(){
            var canvas = document.getElementById('myChart01');
